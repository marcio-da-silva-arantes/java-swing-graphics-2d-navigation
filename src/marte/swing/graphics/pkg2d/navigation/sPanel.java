...
public class sPanel extends JPanel implements iDimensions{
    public static final int WGAP = 5;
    public static final int HGAP = 5;
    public static final FlowLayout default_layout = new FlowLayout(FlowLayout.CENTER, WGAP, HGAP);
    
    
    public final iUpdate up;
    protected boolean dinamicHeight = false;
    
    protected final Color cDEFAULT;// = Color.LIGHT_GRAY;

    public sPanel(Color default_color) {
        this(default_layout, default_color);
    }
    public sPanel(iUpdate up, Color default_color) {
        this(default_layout, up, default_color);
    }
